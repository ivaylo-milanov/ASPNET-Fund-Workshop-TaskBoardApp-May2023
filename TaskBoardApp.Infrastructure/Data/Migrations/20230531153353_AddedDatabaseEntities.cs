...
{
    public partial class AddedDatabaseEntities : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: true, comment: "Task createdOn"),
                    BoardId = table.Column<int>(type: "int", nullable: false, comment: "Task board id"),
                    OwnerId = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "Task owner id")
                },
                constraints: table =>
                {
